...
namespace Finary.Core.Utils
{
    public static class DateUtils
    {
        ...
        public static DateTime GetDaysEnd(string calenderType)
        {
            /*if(DateTime.Now.DayOfWeek==DayOfWeek.Friday || DateTime.Now.DayOfWeek == DayOfWeek.Sunday || DateTime.Now.DayOfWeek == DayOfWeek.Tuesday || DateTime.Now.DayOfWeek == DayOfWeek.Thursday)
            {
